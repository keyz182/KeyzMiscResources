...
```
[h1]Keyz' Misc Resources[/h1]

A library mod of various resources (shaders, fonts, etc) that other mods can use.
...
[url=https://github.com/keyz182/Keyz'-Misc-Resources][img]https://img.shields.io/static/v1?label=Keyz'%20Misc%20Resources&message=Fork%20me%20on%20github&color=d2e885&logo=github[/img][/url]
```
